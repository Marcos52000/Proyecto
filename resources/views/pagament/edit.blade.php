...
@section('content')
<form class='container' action="/gestiopagament/edit/{{$pagaments->id}}" method="Post">
  {!! csrf_field() !!}
  ...
  <a href="/gestiopagament" class="btn btn-danger ml-4">cancela</a>
</form>
@endsection
